...
#  "--wdir", "~/Documents/CoreMicrobiome/Julianas_V4_OTUtab/date_052322",
#  "--outdir", "~/Documents/CoreMicrobiome/Julianas_V4_OTUtab/date_052322/dada2_rStudio",
#  "--path", "~/Documents/CoreMicrobiome/Julianas_V4_OTUtab/date_052322/raw",
#  "--filtpath", "~/Documents/CoreMicrobiome/Julianas_V4_OTUtab/date_052322/dada2/flt",
#  "--fwdptn", "_R1_",
#  "--revptn", "_R2_",
...
sample.names.fwd<-sapply(strsplit(basename(flts.fwd), "_"), 
                         function (x) paste(x[1:1], collapse="_"), simplify=F)
...
#r save workspace
# save.image(paste0(outR, "/Dada2Script2-Mrkdown.RData"))
...
#r save workspace
# save.image(paste0(outdir, "/Dada2Script2-Mrkdown.RData"))
...
saveRDS(taxid, paste0(outR, "/tax.rds"))
